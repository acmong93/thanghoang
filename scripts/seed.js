...
const settings = {
  ...
  hours: '9:00 – 21:00, tất cả các ngày trong tuần',
  ...
  pricing_note: 'Mức giá hiển thị mang tính tham khảo. Liên hệ Rosé để nhận báo giá chi tiết cùng ưu đãi đang có.'
};
...
const albums = [
  {
    ...
    desc: 'Một câu chuyện có thật của khách hàng Rosé — nhẹ nhàng, đời thường và đầy yêu thương. Đúng tinh thần tối giản mà sâu lắng chúng tôi theo đuổi.',
  ...
  },
  {
    ...
    desc: 'Trong trẻo và tinh khôi, nhường trọn khung hình cho cảm xúc tự nhiên của hai người. Tông màu nhẹ như hơi thở, để nét bình yên của tình yêu tự cất lời.',
  ...
  },
  {
    ...
    desc: 'Sang trọng và thời thượng như một trang bìa tạp chí. Bố cục mạnh, màu sắc khác biệt, tôn trọn vẻ kiêu sa của cô dâu chú rể.',
  ...
  },
  {
    ...
    desc: 'Màu sắc mang hơi hướng điện ảnh, nhịp kể chậm và sâu. Mỗi khung hình là một tác phẩm có chiều sâu cảm xúc, đậm tinh thần quiet luxury.',
  ...
  },
  {
    ...
    desc: 'Thiên nhiên trong trẻo làm nền cho câu chuyện tình. Ánh sáng tự nhiên, sắc xanh dịu mắt — không gian rộng mở cho những khoảnh khắc thật nhất.',
  ...
  },
  {
    ...
    desc: 'Bối cảnh được dàn dựng tỉ mỉ đến từng chi tiết, đưa hai bạn bước vào một thước phim tình yêu của riêng mình — sang trọng mà vẫn đầy lãng mạn.',
  ...
  },
  {
    ...
    desc: 'Bộ sưu tập tôn vinh vẻ đẹp cô dâu trong sắc hồng phấn đặc trưng của Rosé. Tinh tế, nữ tính và hiện đại — một chữ ký thị giác không thể nhầm lẫn.',
  ...
  },
  {
    ...
    desc: 'Trọn vẹn cảm xúc chân thật của ngày trọng đại — từ khoảnh khắc chuẩn bị đến giây phút trao nhau lời hẹn ước. Không dàn dựng, chỉ có những giọt nước mắt hạnh phúc.',
  ...
  },
  {
    ...
    desc: 'Khi thị trường vẫn loay hoay Việt hoá concept của nước ngoài, Rosé chọn con đường khác: sáng tạo từ gốc rễ Việt Nam. Lam Điệp bắt đầu từ sắc xanh men lam — màu của di sản và sự tĩnh tại đầy khí chất. Linh hồn của câu chuyện là cánh bướm Lam Điệp: lời hẹn ước được tái sinh trên một tuyệt tác thủ công, che chở cho một tình yêu lãng mạn và bất tử. Từng chi tiết, từ chiếc trâm cài tóc đến hoạ tiết trên áo chú rể, đều là một mảnh ghép của câu chuyện lớn ấy.',
  ...
  },
  {
    ...
    desc: 'Concept độc bản lấy cảm hứng từ quốc hoa của người Việt. Sen gợi sự thuần khiết, thanh cao và bình yên — được kể lại bằng ngôn ngữ thời trang cưới đương đại. Nơi truyền thống và tinh thần tối giản gặp nhau trong từng khung hình.',
...
const pricing = [
  {
    ...
    intro: 'Chụp tại studio độc quyền và ngoại cảnh. Makeup, thử váy miễn phí — album thiết kế riêng cho từng cặp đôi.',
  ...
  },
  {
    ...
    intro: 'Ghi lại ngày cưới đúng như nó diễn ra — chân thật, không dàn dựng. Ekip linh hoạt, không bỏ lỡ một khoảnh khắc nào.',
    ...
    tiers: [
      ...
      { name: 'Phóng Sự & Video', price: '19.900.000đ', note: 'Ảnh và phim cùng lúc', items: ['Ekip ảnh và quay phim','Phim highlight cảm xúc','Ảnh chỉnh sửa đầy đủ','Hậu kỳ phim chuẩn điện ảnh'] }
    ]
  },
  {
    slug: 'combo', name: 'Báo Giá Combo Trọn Gói', tag: 'Trọn gói tiết kiệm',
    intro: 'Ảnh cưới, váy và phóng sự trong một hành trình liền mạch — từ pre-wedding tới ngày cưới, tối ưu cả trải nghiệm lẫn chi phí.',
  ...
  },
  {
    ...
    intro: 'Những khoảnh khắc sum vầy, kỷ niệm ngày cưới hay album đầu đời của bé — với cùng chất lượng và sự tử tế của Rosé.',
...
const posts = [
  {
    ...
    body: [
      'Khi thị trường vẫn loay hoay Việt hoá những concept của nước ngoài, Rosé chọn một con đường khác: sáng tạo hoàn toàn từ gốc rễ Việt Nam.',
      ...
      'Từng chi tiết nhỏ, từ chiếc trâm cài tóc đến hoạ tiết trên áo chú rể, đều là một mảnh ghép của câu chuyện lớn. Sự khác biệt không nằm ở việc sao chép giỏi đến đâu, mà ở việc giải mã và kể lại văn hoá của mình sâu sắc thế nào.'
    ].join('\n\n')
  },
  {
    ...
    excerpt: 'Vài lưu ý nhỏ về da, tóc, trang phục và tinh thần để buổi chụp của hai bạn thật thoải mái, tự tin.',
    body: [
      ...
      'Chuẩn bị đủ phụ kiện đi kèm: giày, túi, trang sức. Mang theo đồ lót phù hợp với từng bộ váy và một chút đồ ăn nhẹ nếu lịch chụp kéo dài.',
      'Và quan trọng nhất: hãy thả lỏng, tin tưởng ekip. Chúng tôi luôn gợi ý dáng và đồng hành, để hai bạn được là chính mình trước ống kính.'
    ].join('\n\n')
  },
  {
    ...
    body: [
      ...
      'Đó cũng chính là tinh thần quiet luxury mà Rosé theo đuổi: vẻ sang trọng không phô trương, đủ tinh tế để bạn còn rung động khi xem lại sau nhiều năm.'
    ].join('\n\n')
  }
];
